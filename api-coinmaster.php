...
class coinmaster{
	...
	private function gettokenfb(){
		$access_tokenfb = [
			'845084156323890|_yZnD1h5aaCoaLsLO4W1oZJ4GQY',
			'2784766325070190|4kDtqjkNcGD2k7Zyb0h2-70O13A',
            '845031642928848|iCPAn8agDXwd1esJW1sM8cU5Qm4',
            '142121647676440|JwNbC0wEhU2FEBY0zuwV7PNjKIg',
            '453595279374091|UGkAkgPCMn_oYUhKG5beAbK4wjQ',
            '693107161404112|qeCVnGY37jp5H8sij13UcmJDjWc',
			'399854347932241|36x6XREGyhvchCQ1Jyq4MrH0Fj8',
			'153851159442688|rjM0tnBaeRZEi1K-JFmura6zpWU',
			'412612886636075|XGZsJVUYHyT1VMBZu_4GgzDQEXI',
			'2643755729269879|ErI4OrZuVgfBoSAeUJZp4EWBqoU',
			'739579879996838|4l36yvgvPLvUf7RjWz2MmhR-lIk',
		];
		$bz = 0;
		do {
			...
			echo "Chisncha Bas | เติมสปิน ✅สำเร็จ🇹🇭: ".$bz."\n";
